...
Timeline._Band.prototype.setBandShiftAndWidth=function(B,E){var D=this._keyboardInput.parentNode;
var C=B+Math.floor(E/2);
if(this._timeline.isHorizontal()){this._div.style.top=B+"px";
var A=this._eventPainter.getType()=="overview";
if(!A){E=Math.ceil((this._eventTracksNeeded)*this._eventTrackIncrement*0.9);
}this._div.style.height=E+"px";
D.style.top=C+"px";
D.style.left="-1em";
}else{this._div.style.left=B+"px";
