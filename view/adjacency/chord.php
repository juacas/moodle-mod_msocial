<style>
@import url(view/adjacency/chord.css);
...
queue()
    .defer(d3.json, "view/adjacency/jsonized.php?id=<?php echo $this->cm->id ?>")
    .await(ready);
...
// 	  return true;//groupPath[0][i].getTotalLength() / 2 - 16 < this.getComputedTextLength();
// 	  })
