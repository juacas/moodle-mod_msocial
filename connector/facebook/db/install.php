...
/**
 * Post-install code for the msocialconnector_facebook module.
 *
...
/**
 * Code run after the msocialconnector_facebook module database tables have been created.
 * Migrate from old tables
 * @global moodle_database $DB
 * @return bool
 */
function xmldb_msocialconnector_facebook_install() {
    global $CFG, $DB;
