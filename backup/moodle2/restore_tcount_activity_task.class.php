...
require_once($CFG->dirroot . '/mod/choice/backup/moodle2/restore_tcount_stepslib.php'); // Because it exists (must)
...
class restore_tcount_activity_task extends restore_activity_task {
    ...
    protected function define_my_steps() {
        // tcount only has one structure step
        $this->add_step(new restore_tcount_activity_structure_step('tcount_structure', 'tcount.xml'));
    }
    ...
    static public function define_decode_contents() {
        ...
        $contents[] = new restore_decode_content('tcount', array('intro'), 'tcount');
    ...
    static public function define_decode_rules() {
        ...
        $rules[] = new restore_decode_rule('TCOUNTVIEWBYID', '/mod/tcount/view.php?id=$1', 'course_module');
        $rules[] = new restore_decode_rule('TCOUNTINDEX', '/mod/tcount/index.php?id=$1', 'course');
...
//        $rules[] = new restore_log_rule('tcount', 'add', 'view.php?id={course_module}', '{choice}');
//        $rules[] = new restore_log_rule('tcount', 'update', 'view.php?id={course_module}', '{choice}');
