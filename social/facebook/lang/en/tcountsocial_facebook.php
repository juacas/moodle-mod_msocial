...
$string['no_facebook_name_advice2'] = 'No Facebook name. Register using Facebook clicking in <a href="{$a->url}"><img src="social/facebook/pix/loginwithfacebook.png" alt="Facebook login"/></a>';
