...
$string['no_twitter_name_advice2'] = 'No Twitter name. Register using Twitter in <a href="{$a->url}"><img src="https://g.twimg.com/dev/sites/default/files/images_documentation/sign-in-with-twitter-gray.png" alt="Facebook login"/></a>';
