...
$string['startdate'] = 'Start of the MSocial monitoring.';
$string['startdate_help'] = 'Activity before this date are not included in the statistics.';
$string['enddate'] = 'End of MSocial monitoring.';
$string['enddate_help'] = 'Activity after this date are not included in the statistics.';
$string['enddate_error'] = 'End date must be after start date.';
...
$string['recalc_kpis'] = 'Recalculate and purge';
...
$string['deleteallkpis'] = 'Reset all results calculated by MSocial';
$string['deleteallsubplugins'] = 'Reset information collected from actual social networks.';
